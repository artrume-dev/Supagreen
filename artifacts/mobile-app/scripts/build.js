...
function getDeploymentDomain() {
  if (process.env.MOBILE_APP_DOMAIN) {
    return stripProtocol(process.env.MOBILE_APP_DOMAIN);
  }
  ...
  console.error(
    "ERROR: No deployment domain found. Set MOBILE_APP_DOMAIN or EXPO_PUBLIC_DOMAIN",
  );
  process.exit(1);
}
